<?php
/**
 * The template for displaying search forms in bootstrap_base
 *
 * @package WordPress
 * @subpackage mb
 */
...
<form class="navbar-form" method="get" role="search" action="<?php echo $site_directory; ?>">
    <div class="input-group">
      <input name="s" type="search" class="form-control has-feedback" placeholder="<?php esc_attr_e( 'Search', 'bootstrap_base' ); ?>">
